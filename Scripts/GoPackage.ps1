...
$7zFilePath = Join-Path $outputDir "DeveInputManager.7z"
$zipFilePath = Join-Path $outputDir "DeveInputManager.zip"

DeleteFileIfExists $7zFilePath
DeleteFileIfExists $zipFilePath
DeleteFolderIfExists $outputDir

$buildPath = Join-Path $solutionRoot "DeveInputManager\bin\Release\netstandard2.1"
